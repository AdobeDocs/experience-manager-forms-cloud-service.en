...
You can now specify the exact folder path of attachments relative to the payload in the **[!UCONTROL Invoke Form Data Model] step of AEM Workflows. It helps you send attachments to a data source for storage.
