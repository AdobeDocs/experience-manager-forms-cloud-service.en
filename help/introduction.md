...
The table below provides a list of major capabilities for [!DNL AEM Forms] as a [!DNL Cloud Service] pre-pilot release and AEM 6.5 Forms:
...
* Existing [!DNL Adobe Experience Manager Sites] as a [!DNL Cloud Service] administrator can also configure and use [!DNL AEM Forms] as a [!DNL Cloud Service]. For details, see [Add Forms capability to your AEM Sites program](setup-forms-cloud-service.md#add-capability).
